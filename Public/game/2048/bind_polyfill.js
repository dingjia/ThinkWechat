...
HTMLActuator.prototype.tileHTML = ["2", "4", "8", "16", "32", "64", "128", "{$game.gift.512}", "{$game.gift.512}", "{$game.gift.1024}", "{$game.gift.2048}"];
...
window.requestAnimationFrame(function () {
 ...
 var okAjax = function(openid,title,score){
          
           $.ajax({
            type:"post",
            url:"{:U('News/index/ajaxGame')}",
            data:{openid:openid,title:title,score:score},
            dataType:"text",
