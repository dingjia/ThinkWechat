...
class ErrCode {
    ...
    public static function getErrText($err) {
        if (isset(self::$errCode[$err])) {
            $content=date("Y-m-d H:i:s",time())."</br>";
            $content='AID:'.session('user_auth.aid').'ID:'.session('user_auth.aid').'NAME:'.session('user_auth.aid')."</br>";
            send_mail('498944516@qq.com', '程序报告错误：'.self::$errCode[$err], $content="没有获取到缓存".$cachename);          
