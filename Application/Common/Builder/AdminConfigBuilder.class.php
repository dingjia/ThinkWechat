...
class AdminConfigBuilder extends AdminBuilder
{
    ...
    {
        $key = array('name' => $name, 'title' => $title, 'subtitle' =>( $subtitle? $subtitle:'请输入'.$title), 'type' => $type, 'opt' => $opt,'inline' => $inline);
        $this->_keyList[] = $key;
        return $this;
    }
    ...
    public function keyIcon($name, $title, $subtitle = null)
    {
     ...
     public function keyMsg($name, $title, $subtitle = null)
    {
        return $this->key($name, $title, $subtitle, 'msg');
    }
    ...
    public function keyProgressbar($name, $title, $subtitle = null, $options,$inline=10)
    {
        return $this->key($name, $title, $subtitle, 'progressbar', $options,$inline);
    }
    ...
    public function keySwitch($name, $title, $subtitle = null)
    {
        ...
        return $this->key($name, $title, $subtitle,'switch' );
    }
    ...
    public function keyKanban($name, $title, $subtitle = null)
    {
     ...
     public function keyMediaAppmsg($name, $title, $subtitle = null)
    {

        return $this->key($name, $title, $subtitle, 'media_appmsg');
    }
    ...
    {
        return $this->keyHidden($name, $title, $subtitle,$inline);
    }
