...
//            $this->setSearchPostUrl('');
    ...
    public function key($name, $title, $type, $opt = null, $width = '250px')
    {
     ...
     * @auth 陈一枭
     */
    public function keyText($name, $title,$width='250px')
    {
        return $this->key($name, text($title), 'text',null,$width);
    }
