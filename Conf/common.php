...
/* 系统数据加密设置 */
'DATA_AUTH_KEY' => 'pev4FCtqZsO8grn3mVXJUD6TRc2aAhxbSlH9wfPN', //默认数据加密KEY
...
'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,pem', //允许上传的文件后缀
...
'__SOURCE__'=>__ROOT__.'/Public/source/',
